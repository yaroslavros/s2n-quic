...
use super::SocketEvents;
use std::os::unix::io::AsRawFd;

#[inline]
pub fn send<'a, Sock: AsRawFd, P: Iterator<Item = &'a libc::msghdr>, E: SocketEvents>(
    socket: &Sock,
    packets: P,
    events: &mut E,
) {
...
#[inline]
pub fn recv<'a, Sock: AsRawFd, P: Iterator<Item = &'a mut libc::msghdr>, E: SocketEvents>(
    socket: &Sock,
    packets: P,
    events: &mut E,
) {
